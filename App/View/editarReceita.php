...
$controllerReceita->editarReceita();
...
<div class="container">
  ...
  <hr>
  <form class="form" action="index.php?action=editarReceita.php&id_receita=<?php echo $receita['id_receita'];?>" method="post">
    <div class="row">
...
<div class="text-center">
  <a href="index.php?action=consultarReceitasUsuario.php" class="btn btn-sm btn-warning" value='Voltar'><i class="fas fa-angle-double-left"></i> Voltar</a>
</div>
<br>
